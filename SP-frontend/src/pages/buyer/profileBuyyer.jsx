      ...
      try {
        ...
        setUser({
          ...
          image: data.own_profile.image
            ? data.own_profile.image.startsWith("http")
              ? data.own_profile.image
              : `${import.meta.env.VITE_API_URL}${data.own_profile.image}`
            : "/default.png",
        });
      } finally {
        setLoading(false);
    ...
    <div className="flex min-h-screen relative bg-white">
      ...
      <div className="flex-1 flex flex-col md:pb-0">
        <div className="flex flex-col items-center px-4  pb-32 md:pb-10 w-full relative">
          <p className="text-2xl font-poppins font-bold text-[#732ccf] mt-10 mb-5">
            PROFILE
          </p>
          ...
          <div className="flex items-center mb-10 w-full">
            <div className="relative">
              ...
              <label
                htmlFor="imageUpload"
                className="absolute bottom-0 -right-2 bg-green-500 p-2 rounded-full hover:bg-green-600 shadow-md transition cursor-pointer"
                title="Edit Photo"
              >
